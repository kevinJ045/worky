...
var __classPrivateFieldIn =
  (this && this.__classPrivateFieldIn) ||
...
var _Tracer_tracer,
  ...
  _Span_spanContext,
  _Context_data,
  _BatchObservableResult_observables,
  _Meter_meter,
  _Counter_instrument,
  _Counter_upDown,
  _Gauge_instrument,
  _Histogram_instrument,
  _Observable_result,
  _ObservableResult_instrument,
  _ObservableResult_isRegularCounter,
  _BaggageImpl_entries;
...
export function enterSpan(span) {
  ...
  const context = (
    (_a = CURRENT.get()) !== null && _a !== void 0 ? _a : ROOT_CONTEXT
...
(function (SpanAttributesLocation) {
  ...
  SpanAttributesLocation[(SpanAttributesLocation["LAST_EVENT"] = 1)] =
    "LAST_EVENT";
  SpanAttributesLocation[(SpanAttributesLocation["LAST_LINK"] = 2)] =
    "LAST_LINK";
...
class TracerProvider {
  ...
  static getTracer(name, version, options) {
    const tracer = new OtelTracer(
      name,
      version,
      options === null || options === void 0 ? void 0 : options.schemaUrl,
    );
...
class Tracer {
  ...
  startActiveSpan(name, optionsOrFn, fnOrContext, maybeFn) {
    ...
    if (options === null || options === void 0 ? void 0 : options.root) {
      ...
      context =
        (_a =
          context !== null && context !== void 0 ? context : CURRENT.get()) !==
          null && _a !== void 0
          ? _a
          : ROOT_CONTEXT;
    }
  ...
  startSpan(name, options, context) {
    ...
    const startTime = timeInputToMs(
      options === null || options === void 0 ? void 0 : options.startTime,
    );
    const parentSpan =
      context === null || context === void 0
        ? void 0
        : context.getValue(SPAN_KEY);
    const attributesCount = countAttributes(
      options === null || options === void 0 ? void 0 : options.attributes,
    );
    const parentOtelSpan =
      parentSpan !== undefined
        ? (_a = getOtelSpan(parentSpan)) !== null && _a !== void 0
          ? _a
          : undefined
        : undefined;
    let otelSpan;
    if (parentOtelSpan || !parentSpan) {
      otelSpan = __classPrivateFieldGet(this, _Tracer_tracer, "f").startSpan(
        parentOtelSpan,
        name,
        (_b =
          options === null || options === void 0 ? void 0 : options.kind) !==
          null && _b !== void 0
          ? _b
          : 0,
        startTime,
      ...
      otelSpan = __classPrivateFieldGet(
        this,
        _Tracer_tracer,
        "f",
      ).startSpanForeign(
    ...
    if (options === null || options === void 0 ? void 0 : options.links)
      span.addLinks(
        options === null || options === void 0 ? void 0 : options.links,
      );
...
class Span {
    ...
    if (!__classPrivateFieldGet(this, _Span_spanContext, "f")) {
      if (__classPrivateFieldGet(this, _Span_otelSpan, "f")) {
        __classPrivateFieldSet(
          this,
          _Span_spanContext,
          __classPrivateFieldGet(this, _Span_otelSpan, "f").spanContext(),
          "f",
        );
      } else {
        __classPrivateFieldSet(
  ...
  addEvent(name, attributesOrStartTime, startTime) {
    if (!__classPrivateFieldGet(this, _Span_otelSpan, "f")) return this;
    let attributes;
    ...
    __classPrivateFieldGet(this, _Span_otelSpan, "f").addEvent(
      name,
      startTimeMs !== null && startTimeMs !== void 0 ? startTimeMs : NaN,
    );
    if (attributes) {
      spanAddAttributes(
        __classPrivateFieldGet(this, _Span_otelSpan, "f"),
  ...
  addLink(link) {
    ...
    const valid = op_otel_span_add_link(
      ...
      (_a = link.context.isRemote) !== null && _a !== void 0 ? _a : false,
      (_b = link.droppedAttributesCount) !== null && _b !== void 0 ? _b : 0,
    );
    if (link.attributes) {
      spanAddAttributes(
        __classPrivateFieldGet(this, _Span_otelSpan, "f"),
  ...
  addLinks(links) {
    ...
    var _a;
    (_a = __classPrivateFieldGet(this, _Span_otelSpan, "f")) === null ||
    _a === void 0
      ? void 0
      : _a.end(timeInputToMs(endTime) || NaN);
  }
  isRecording() {
  ...
  setStatus(status) {
    ...
    _a === void 0
      ...
      : _a.setStatus(
          status.code,
          (_b = status.message) !== null && _b !== void 0 ? _b : "",
        );
    return this;
  }
  updateName(name) {
...
(() => {
  ...
  getOtelSpan = (span) =>
    __classPrivateFieldIn(_Span_otelSpan, span)
      ? __classPrivateFieldGet(span, _Span_otelSpan, "f")
      : undefined;
})();
...
class Context {
  constructor(data) {
    ...
    __classPrivateFieldSet(
      this,
      _Context_data,
      Object.assign({ __proto__: null }, data),
      "f",
    );
  }
  getValue(key) {
...
class Meter {
  ...
  createCounter(name, options) {
    if (
      (options === null || options === void 0 ? void 0 : options.valueType) !==
        undefined &&
      (options === null || options === void 0 ? void 0 : options.valueType) !==
        1
    ) {
    ...
    const instrument = __classPrivateFieldGet(
      this,
      _Meter_meter,
      "f",
    ).createCounter(
  ...
  createHistogram(name, options) {
    ...
    const instrument = __classPrivateFieldGet(
      ...
      options === null || options === void 0 ? void 0 : options.unit,
      (_a =
        options === null || options === void 0 ? void 0 : options.advice) ===
        null || _a === void 0
        ? void 0
        : _a.explicitBucketBoundaries,
    );
...
class Counter {
  ...
  add(value, attributes, _context) {
    ...
    record(
      __classPrivateFieldGet(this, _Counter_instrument, "f"),
      value,
      attributes,
    );
  }
...
class Gauge {
  ...
  record(value, attributes, _context) {
    record(
      __classPrivateFieldGet(this, _Gauge_instrument, "f"),
      value,
      attributes,
    );
  }
...
class Histogram {
  ...
  record(value, attributes, _context) {
    record(
      __classPrivateFieldGet(this, _Histogram_instrument, "f"),
      value,
      attributes,
    );
  }
...
(() => {
  getObservableResult = (observable) =>
    __classPrivateFieldGet(observable, _Observable_result, "f");
})();
class ObservableResult {
  ...
  observe(value, attributes) {
    ...
    recordObservable(
      __classPrivateFieldGet(this, _ObservableResult_instrument, "f"),
      value,
      attributes,
    );
  }
}
((_ObservableResult_instrument = new WeakMap()),
  (_ObservableResult_isRegularCounter = new WeakMap()));
...
function otelLog(message, level) {
  var _a;
  const currentSpan =
    (_a = CURRENT.get()) === null || _a === void 0
      ? void 0
      : _a.getValue(SPAN_KEY);
  const otelSpan =
    currentSpan !== undefined ? getOtelSpan(currentSpan) : undefined;
...
class W3CTraceContextPropagator {
  inject(context, carrier, setter) {
    var _a;
    const spanContext =
      (_a = context.getValue(SPAN_KEY)) === null || _a === void 0
        ? void 0
        : _a.spanContext();
    if (
      !spanContext ||
...
class BaggageImpl {
  constructor(entries) {
    ...
    __classPrivateFieldSet(
      this,
      _BaggageImpl_entries,
      entries ? new SafeMap(entries) : new SafeMap(),
      "f",
    );
  }
  getEntry(key) {
    const entry = __classPrivateFieldGet(this, _BaggageImpl_entries, "f").get(
      key,
    );
    if (!entry) {
      return undefined;
  ...
  getAllEntries() {
    return ArrayPrototypeMap(
      ArrayFrom(
        MapPrototypeEntries(
          __classPrivateFieldGet(this, _BaggageImpl_entries, "f"),
        ),
      ),
  ...
  setEntry(key, entry) {
    const newBaggage = new BaggageImpl(
      __classPrivateFieldGet(this, _BaggageImpl_entries, "f"),
    );
    __classPrivateFieldGet(newBaggage, _BaggageImpl_entries, "f").set(
      key,
      entry,
    );
    return newBaggage;
...
export class W3CBaggagePropagator {
  inject(context, carrier, setter) {
    ...
    const keyPairs = ArrayPrototypeSlice(
      ArrayPrototypeFilter(getKeyPairs(baggage), (pair) => {
...
export function bootstrap(config) {
  ...
  const { 0: tracingEnabled, 1: metricsEnabled, 2: consoleConfig } = config,
    propagators = __rest(config, ["0", "1", "2"]);
  ...
  if (TRACING_ENABLED || METRICS_ENABLED) {
    const otel =
      (_a = globalThis[(_b = SymbolFor("opentelemetry.js.api.1"))]) !== null &&
      _a !== void 0
        ? _a
        : (globalThis[_b] = {
